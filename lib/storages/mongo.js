 ...
 *   - port            optional (default: 27107)
 *   - username        optional
 *   - password        optional
 *   - auto_reconnect  optional (default: false)
 *   - ssl             optional (default: false)
 *   - url             optional
 */
var MongoStorage = module.exports = function(options) {
  options = options || {};
  this.type = 'mongodb';
  ...
  if(!options.db) {
    throw new Error('Required MongoStorage option `db` missing');
  }
...
MongoStorage.prototype.get = function(args, callback) {
  var collectionName;
...
MongoStorage.prototype.set = function(item, callback) {
  var self = this;
  var collectionName;
...
MongoStorage.prototype.list = function(callback) {
  var self = this;
...
MongoStorage.prototype.save = function(data, callback) {
  var self = this;
  async.parallel([
    function(next) {
...
MongoStorage.prototype.clear = function(callback) {
  var self = this;
  async.parallel([
    function(next) {
